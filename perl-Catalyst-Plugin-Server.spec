...
Url:		https://metacpan.org/dist/Catalyst-Plugin-Server
Source0:	https://cpan.metacpan.org/authors/id/J/JL/JLMARTIN/Catalyst-Plugin-Server-%{upstream_version}.tar.gz
